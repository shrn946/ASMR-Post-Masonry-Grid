...
function masonry_grid_settings_page() {
    ...
    <div class="wrap" style="font-size: 20px;">
        ...
        <div class="video-link">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/R8mW9sZPv4A?si=LugShN1oG9sAkOEW&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
    </div>
    <?php
}
