...
// Function for Full-width Grid
function full_width_post_grid($atts) {
    ob_start();
    ...
    <div class="grid full-width">
        ...
        while ($query->have_posts()) : $query->the_post();
            ...
            $background_image = $featured_image_url ? $featured_image_url : plugins_url('../img/fallback-img.jpg', __FILE__);
...
// Create a new shortcode for full-width grid
add_shortcode('full_width_post_grid', 'full_width_post_grid');


// Shortcode to show all posts without any category filters
function custom_show_all_posts_shortcode() {
    ob_start();

    // Use the shortcode for full-width grid
    echo do_shortcode('[full_width_post_grid exclude_category=""]');

    return ob_get_clean();
}

// Create a new shortcode for showing all posts
add_shortcode('custom_show_all_posts', 'custom_show_all_posts_shortcode');?>